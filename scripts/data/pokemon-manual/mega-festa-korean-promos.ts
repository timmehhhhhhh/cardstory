...
export const POKEMON_MANUAL_ENTRIES: ManualCatalogItemEntry[] = [
  {
    ...
    // this file (confirmed 404 live) — only an 86px thumb exists, and
    // arbitrary widths don't generate on demand. The full-size original is
    // only 394x550 already, so it doubles as a perfectly reasonable "small"
    // image rather than falling back to the tiny 86px thumb.
    imageSmallUrl: "https://archives.bulbagarden.net/media/upload/9/98/MagikarpMPromo40.jpg",
