...
export const POKEMON_MANUAL_ENTRIES: ManualCatalogItemEntry[] = [
...

  {
    ...
    artist: "Lee Mina",
    cardType: "Pokémon",
    // 250px was never actually generated by Bulbagarden's thumbnailer for
    // this file (confirmed 404 live) — only 86px/431px exist (per the
    // file's own wiki page), and arbitrary widths don't generate on demand.
    // 431px is the closest to the old 250px convention that's actually live.
    imageSmallUrl: "https://archives.bulbagarden.net/media/upload/thumb/3/3f/DittoSVPromo173.jpg/431px-DittoSVPromo173.jpg",
