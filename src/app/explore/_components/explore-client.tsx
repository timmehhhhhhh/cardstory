  ...
  return (
    <div className="mx-auto flex max-w-7xl flex-col gap-6 px-4 py-6 sm:px-6 lg:flex-row">
      ...
      <div className="min-w-0 flex-1">
        <div className="sticky top-14 md:top-0 z-30 -mx-4 mb-4 flex flex-wrap items-center justify-between gap-2 border-b border-border bg-background/95 px-4 pt-3 pb-3 backdrop-blur supports-backdrop-blur:bg-background/80 sm:-mx-6 sm:px-6">
